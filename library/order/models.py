...
class Order(models.Model):
    ...
    def create(user, book, plated_end_at=None):
        if user.pk is None or book.pk is None:
            return None
        ...
        elif isinstance(plated_end_at, int):
            plated_end_at = timezone.datetime.fromtimestamp(plated_end_at, tz=timezone.utc)
        elif not isinstance(plated_end_at, timezone.datetime):
            return None
